                    ...
                    getActivity()?.runOnUiThread {
                        ...
                        when(weather) {
                            "Thunderstorm" -> {
                                ...
                                SendNotify("Лучше остаться дома!", R.drawable.thunder)
                            }
                            "Drizzle" -> {
                                Glide.with(this@HomeFragment).load(R.drawable.rainy).into(imageView1)
                                SendNotify("Очень холодно!", R.drawable.rainy)
                            }
                            "Rain" ->  {
                                Glide.with(this@HomeFragment).load(R.drawable.rainy).into(imageView1)
                                SendNotify("Возьмите зонт!", R.drawable.rainy)
                            }
                            "Snow" -> {
                                Glide.with(this@HomeFragment).load(R.drawable.snowy).into(imageView1)
                                SendNotify("Ура! Выпал снег!", R.drawable.snowy)
                            }
                            "Clouds" -> {
                                Glide.with(this@HomeFragment).load(R.drawable.cloudy).into(imageView1)
                                SendNotify("Облачно", R.drawable.cloudy)
                            }
                            "Clear" -> {
                                Glide.with(this@HomeFragment).load(R.drawable.sunny).into(imageView1)
                                SendNotify("Время идти гулять!", R.drawable.sunny)
                            }
                            "Fog" -> {
                                Glide.with(this@HomeFragment).load(R.drawable.fog).into(imageView1)
                                SendNotify("На улице туман, лучше остаться дома!", R.drawable.fog)
                            }
                        }
                    }
